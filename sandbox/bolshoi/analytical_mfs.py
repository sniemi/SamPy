...
def calculate_analytical_dm_mfs(redshift,
    ...
    hmfPS = HaloMassFcn(None, omega_matter0=Omega_0, omega_lambda0=lambdaL,
    ...
    hmfST = HaloMassFcn(None, omega_matter0=Omega_0, omega_lambda0=lambdaL,
                        omega_baryon0=Omega_b, hubble0=h_100, this_redshift=z, 
                        log_mass_min=7., log_mass_max=16., sigma8input=sigma8, 
                        primordial_index=n, fitting_function=3)

    hmfWa = HaloMassFcn(None, omega_matter0=Omega_0, omega_lambda0=lambdaL,
                        omega_baryon0=Omega_b, hubble0=h_100, this_redshift=z, 
                        log_mass_min=7., log_mass_max=16., sigma8input=sigma8, 
