...
"""
Create a GUI for the simviz1.py script by using the Parameters
class and inheriting from class SimViz in the simviz1cp.py
script. This is a very flexible and efficient approach for
extending a command-line oriented script with a GUI.
"""

import sys, os, math, string
from simviz1cp import SimViz
# find the py4cs.InputParameters module:
sys.path.insert(0, os.path.join(os.pardir, os.pardir, 
                                os.pardir, 'tools'))

from py4cs.ParameterInterface import Parameters, AutoSimVizCGI
import cgi
...
class SimVizCGI(SimViz):
    def __init__(self):
        ...
        self.CGI.make(
            ...
            'wrapper.sh.cgi?s=simviz1cpCGI.py.cgi',
