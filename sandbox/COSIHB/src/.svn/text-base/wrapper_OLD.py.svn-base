...
if __name__ == '__main__':    
    '''
    Main program. All plotting related lines; constants, creation of instances, reading data,
    data manipulation and finally plotting. Each plot has been isolated by a comment block.
    '''
    import sys    
    import os
    import IO
    ...
    #NUV background 11 cts/sec/cm^2
    #UV background 1.5 cts/sec/cm^2
...
#########################################################################################
        ...
        G130Msens = selectSensitivity(G130Ms[0][4], G130Ms[0][5], wv, width)
        ...
        plot.Chapter13SNPlot(G130MSNRdata, 'G130M', str(wv), outputfolder + 'G130MSNR')
        ...
        G160MSNRdata = []
        wv = 1610
        G160Msens = selectSensitivity(G160Ms[0][4], G160Ms[0][5], wv, width)
        ...
        plot.Chapter13SNPlot(G160MSNRdata, 'G160M', str(wv), outputfolder + 'G160MSNR')
        ...
        G140LSNRdata = []
        wv = 1230
        G140Lsens = selectSensitivity(G140Ls[0][4], G140Ls[0][5], wv, width)
        ...
        plot.Chapter13SNPlot(G140LSNRdata, 'G140L', str(wv), outputfolder + 'G140LSNR')

        #New wavelength plots
        #G130M 1291 FUVA 2 1291.9300 1433.4300
        dt ={'names': ('grating', 'central', 'segment', 'fp-pos', 'start', 'stop'),
             'formats': ('S5', 'i4', 'S4', 'i4', 'f4', 'f4')}
        gratings = ['G130M', 'G160M', 'G140L']
        ...
        G185Ms = selectSensitivity(G185Msens[0][4], G185Msens[0][5], wv, width)
        ...
        plot.Chapter13SNPlot(G185MSNRdata, 'G185M', str(wv), outputfolder + 'G185MSNR', FUV=False)        
        ...
        G225Ms = selectSensitivity(G225Msens[0][4], G225Msens[0][5], wv, width)
        ...
        plot.Chapter13SNPlot(G225MSNRdata, 'G225M', str(wv), outputfolder + 'G225MSNR', FUV=False)   
        ...
        G285Ms = selectSensitivity(G285Msens[0][4], G285Msens[0][5], wv, width)
        ...
        plot.Chapter13SNPlot(G285MSNRdata, 'G285M', str(wv), outputfolder + 'G285MSNR', FUV=False)  
        ...
        G230Ls = selectSensitivity(G230Lsens[0][4], G230Lsens[0][5], wv, width)
        ...
        plot.Chapter13SNPlot(G230LSNRdata, 'G230L', str(wv), outputfolder + 'G230LSNR', FUV=False)
#########################################################################################
        #Spatial profiles
