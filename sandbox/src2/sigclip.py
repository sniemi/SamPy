# -*- encoding: utf-8 -*-
#
# (C) 2008 Ricardo Cárdenes <rcardenes@not.iac.es>
#          for the Nordic Optical Telescope
# Based on IDL code by Michael Andersen

import numpy

def stdev(array, lowcut = 4, highcut = 4, maxnit = 5, verbose = False):
