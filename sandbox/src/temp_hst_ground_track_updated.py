...
# Get the NUV lmevents saa data
pf = open('nuv_lmevents_smov.pickle')
xsaadata = cPickle.load(pf)
ysaadata = cPickle.load(pf)
zsaadata = cPickle.load(pf)
pf.close()
xsaadata.shape = zsaadata.shape
ysaadata.shape = zsaadata.shape
#zsaadata.shape = (360,59)
...
xn2,yn2 = m([357.4-360,357.6-360,356.9-360,355.0-360,352.3-360,348.7-360,342.9-360,336.4-360,324.8-360,297.2-360,286.1-360,283.0-360,279.9-360,277.5-360,276.5-360,276.4-360,276.7-360,357.4-360], \
            [-28.3,-26.1,-23.7,-21.2,-18.8,-16.3,-13.0,-10.6, -9.1,-11.9,-14.9,-17.0,-19.1,-21.3,-23.7,-26.0,-28.6,-28.3])
# SAA 03
...
xn3,yn3 = m([ 14.0, 15.0, 13.0,  1.5,341.0-360,330.4-360,318.8-360,297.2-360,286.1-360,279.9-360,277.5-360,276.5-360,276.4-360,276.7-360, 14.0], \
            [-28.3,-27.5,-26.1,-19.8, -9.6, -7.6, -6.0, -7.9,-12.0,-17.1,-20.3,-23.5,-26.0,-28.6,-28.3])
# SAA 04
...
xn4,yn4 = m([ 19.0,  1.0,345.0-360,335.0-360,312.0-360,294.0-360,284.0-360,278.0-360,272.0-360,267.0-360,269.0-360, 19.0], \
            [-28.5,-16.0, -6.5, -2.0,  1.0, -3.0, -7.0,-10.0,-15.0,-20.0,-30.0,-28.5])
# SAA 05,23
...
xn5,yn5 = m([294.0-360, 39.0, 34.0, 24.0,  9.0, 354.0-360,335.0-360,312.0-360,294.0-360,277.0-360,267.0-360,269.0-360,294.0-360], \
            [-50.0,-30.0,-25.0,-21.0,-15.0,-10.2, -2.0,  1.0, -3.0, -8.0,-20.0,-30.0,-50.0])
# SAA 06
...
x6,y6 = m([ 20.0, 21.0, 19.0,  7.5,347.0-360,336.4-360,324.8-360,303.2-360,292.1-360,285.9-360,283.5-360,282.5-360,282.4-360,282.7-360, 20.0], \
          [-28.3,-27.5,-26.1,-19.8, -9.6, -7.6, -6.0, -7.9,-12.0,-17.1,-20.3,-23.5,-26.0,-28.6,-28.3])
xn6,yn6 = m([ 14.0, 15.0, 13.0,  1.5,341.0-360,330.4-360,318.8-360,297.2-360,286.1-360,279.9-360,277.5-360,276.5-360,276.4-360,276.7-360, 14.0], \
          [-28.3,-27.5,-26.1,-19.8, -9.6, -7.6, -6.0, -7.9,-12.0,-17.1,-20.3,-23.5,-26.0,-28.6,-28.3])
# SAA 07
...
# COS LMEVENTS SMOV data
xclsd,yclsd = m(xsaadata,ysaadata)

ctfmap = arange(1.0,101.0,5.0)
ctf = m.contour(xclsd,yclsd,zsaadata,ctfmap, cmap=cm.jet)
clabel(ctf, inline=1, fmt="%1.1f",fontsize=4)
saa02 = m.plot(x2,y2,marker='D',markersize=3.0,markeredgewidth=0.0,color='red',linestyle='--',label='02')
saan02 = m.plot(xn2,yn2,marker='D',markersize=4.0,markeredgewidth=0.0,color='red',linestyle='-',label='n02')
saa03 = m.plot(x3,y3,marker='v',markersize=3.0,markeredgewidth=0.0,color='darkorchid',linestyle='--',label='03')
saan03 = m.plot(xn3,yn3,marker='v',markersize=4.0,markeredgewidth=0.0,color='darkorchid',linestyle='-',label='n03')
saa04 = m.plot(x4,y4,marker='^',markersize=3.0,markeredgewidth=0.0,color='maroon',linestyle='--',label='04')
saan04 = m.plot(xn4,yn4,marker='^',markersize=4.0,markeredgewidth=0.0,color='maroon',linestyle='-',label='n04')
saa05 = m.plot(x5,y5,marker='s',markersize=3.0,markeredgewidth=0.0,color='blue',linestyle='--',label='05')
saan05 = m.plot(xn5,yn5,marker='s',markersize=4.0,markeredgewidth=0.0,color='blue',linestyle='-',label='n05')
saa06 = m.plot(x6,y6,marker='x',markersize=3.0,markeredgewidth=1.0,color='green',linestyle='--',label='06')
saan06 = m.plot(xn6,yn6,marker='x',markersize=4.0,markeredgewidth=1.0,color='green',linestyle='-',label='n06')
...
legend((saan02,saan03,saan04,saan05,saan06,hst), \
       ( \
        ...
        'HST position at 1 minute intervals' \
        ), \
...
# draw the title.
title('Dashed Lines = Current SAA Contours\nSolid Lines = Proposed SAA Contours (6d W shift)\nOther lines = COS/NUV HVSAA LMEVENTS')
#title('Dashed Lines = Current SAA Contours\nSolid Lines = Proposed SAA Contours (6d W shift)')
show()
