...
if __name__ == '__main__':
    ...
    #    print 'Plot %i, slope %f with only the last two measurements.' % (c, fit2[0])
        print 'Plot %i, change %f per cent per year, only on orbit data. Green dotted line.' % (c, fit2[0]*356.*100.)
    ...
    #    print 'Plot %i, slope %f when the two outliers have been excluded.' % (c, fit3[0])
        print 'Plot %i, change %f per cent per year, all data excluding the two outliers. Magenta dot-dashed' % (c, fit3[0]*356.*100.)
    ...
    #    print 'Plot %i, slope %f, only ground data, two outliers have been excluded.' % (c, fit4[0])
        print 'Plot %i, change %f per cent per year, ground data excluding the two clear outliers. Red hatched line' % (c, fit4[0]*356.*100.)
